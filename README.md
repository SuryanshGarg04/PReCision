...
GET    /api/v1/github/repositories/:owner/:repo/pulls/:pullNumber
GET    /api/v1/github/repositories/:owner/:repo/pulls/:pullNumber/files
GET    /api/v1/github/repositories/:owner/:repo/commits
GET    /api/v1/github/repositories/:owner/:repo/compare?base=...&head=...
GET    /api/v1/github/repositories/:owner/:repo/diff?base=...&head=...
